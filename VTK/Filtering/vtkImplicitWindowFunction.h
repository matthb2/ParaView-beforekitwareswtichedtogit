...
=========================================================================*/
// .NAME vtkImplicitWindowFunction - implicit function transforms another implicit function to lie in a window
// .SECTION Description
// vtkImplicitWindowFunction is used to modify the output of another implicit function
// to lie within a specified "window", or function range. This can be used to
// add "thickness" to cutting or clipping functions.
//
...
// .SECTION See Also
// vtkImplictFunction vtkClipper vtkCutter
...
public:
  ...
  // Description:
  // Specify the range of function values which are considered to lie within the
