                                 ...
                                 double fx)
{
  ...
  if (inIdX1 == inExtX && inIdX0 < inExtX && fx < 0.5)
    {
                                      ...
                                      double fx)
{
  if ((inIdX0 >= 0 && inIdX1 < inExtX) ||
      (inIdX0 == -1 && fx >= 0.5) ||
      (inIdX1 == inExtX && inIdX0 < inExtX && fx < 0.5))
    {
    return 0;
    }
                                                 ...
                                                 F newmat[4][4])
{
  ...
  for (i = 0; i < 8; i++)
    {
    // calculate transform using exactly the same method as
    // in vtkImageResliceExecute
    idX = outExt[i%2];
    idY = outExt[2+(i/2)%2];
    idZ = outExt[4+(i/4)%2];
