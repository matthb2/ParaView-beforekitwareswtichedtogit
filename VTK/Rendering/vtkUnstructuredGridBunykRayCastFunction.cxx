...
vtkCxxRevisionMacro(vtkUnstructuredGridBunykRayCastFunction, "$Revision$");
...
template <class T>
static vtkIdType TemplateCastRay(const T *scalars, 
...
template<class T>
static void TemplateIntegrateColor(vtkIdType numIntersections,
                                   int numComponents,
