...
// class vtkOpenGLRenderWindow. vtkQuartzRenderWindow interfaces to the
// OpenGL graphics library using Quartz on Mac OSX.
...
class VTK_RENDERING_EXPORT vtkQuartzRenderWindow : public vtkOpenGLRenderWindow
{
public:
