...
=========================================================================*/
// .NAME vtkEnSight6Reader2 - class to read EnSight6 files
// .SECTION Description
// vtkEnSight6Reader2 is a class to read EnSight6 files into vtk.
...
#ifndef __vtkEnSight6Reader2_h
#define __vtkEnSight6Reader2_h
...
class VTK_EXPORT vtkEnSight6Reader2 : public vtkEnSightReader2
{
public:
  static vtkEnSight6Reader2 *New();
  vtkTypeRevisionMacro(vtkEnSight6Reader2, vtkEnSightReader2);
...
private:
  vtkEnSight6Reader2(const vtkEnSight6Reader2&);  // Not implemented.
  void operator=(const vtkEnSight6Reader2&);  // Not implemented.
};
