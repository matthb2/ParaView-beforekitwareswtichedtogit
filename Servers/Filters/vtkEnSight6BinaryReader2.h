...
=========================================================================*/
// .NAME vtkEnSight6BinaryReader2 - class to read binary EnSight6 files
// .SECTION Description
// vtkEnSight6BinaryReader2 is a class to read binary EnSight6 files into vtk.
...
#ifndef __vtkEnSight6BinaryReader2_h
#define __vtkEnSight6BinaryReader2_h
...
class VTK_EXPORT vtkEnSight6BinaryReader2 : public vtkEnSightReader2
{
public:
  static vtkEnSight6BinaryReader2 *New();
  vtkTypeRevisionMacro(vtkEnSight6BinaryReader2, vtkEnSightReader2);
...
protected:
  ...
  ifstream *IFile;
private:
  vtkEnSight6BinaryReader2(const vtkEnSight6BinaryReader2&);  // Not implemented.
  void operator=(const vtkEnSight6BinaryReader2&);  // Not implemented.
};
