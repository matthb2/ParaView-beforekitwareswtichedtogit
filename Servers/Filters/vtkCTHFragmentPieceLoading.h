...
=========================================================================*/
// .NAME vtkCTHFragmentPieceLoading
// .SECTION Description
// Data structure that describes a fragment's loading.
// Holds its id and its loading factor.

#ifndef __vtkCTHFragmentPieceLoading_h
#define __vtkCTHFragmentPieceLoading_h
...
vtksys_ios::ostream &operator<<(vtksys_ios::ostream &sout, vtkCTHFragmentPieceLoading &fp);
