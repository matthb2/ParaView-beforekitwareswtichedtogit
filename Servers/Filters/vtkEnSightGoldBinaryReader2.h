...
=========================================================================*/
// .NAME vtkEnSightGoldBinaryReader2 - class to read binary EnSight Gold files
// .SECTION Description
// vtkEnSightGoldBinaryReader2 is a class to read EnSight Gold files into vtk.
...
#ifndef __vtkEnSightGoldBinaryReader2_h
#define __vtkEnSightGoldBinaryReader2_h

#include "vtkEnSightReader2.h"

class vtkMultiBlockDataSet;

class VTK_EXPORT vtkEnSightGoldBinaryReader2 : public vtkEnSightReader2
{
public:
  static vtkEnSightGoldBinaryReader2 *New();
  vtkTypeRevisionMacro(vtkEnSightGoldBinaryReader2, vtkEnSightReader2);
...
private:
  ...
  void operator=(const vtkEnSightGoldBinaryReader2&);  // Not implemented.
};
