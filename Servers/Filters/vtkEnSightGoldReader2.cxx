...
vtkCxxRevisionMacro(vtkEnSightGoldReader2, "$Revision$");
...
//----------------------------------------------------------------------------
vtkEnSightGoldReader2::vtkEnSightGoldReader2()
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadGeometryFile(const char* fileName, int timeStep,
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadMeasuredGeometryFile(
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadScalarsPerNode(const char* fileName, const char* description,
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadVectorsPerNode(const char* fileName, const char* description,
  int timeStep, vtkMultiBlockDataSet *compositeOutput,
  int measured)
{
  char line[256], formatLine[256], tempLine[256];
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadTensorsPerNode(const char* fileName, const char* description,
  int timeStep, vtkMultiBlockDataSet *compositeOutput)
{
  char line[256];
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadScalarsPerElement(const char* fileName,
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadVectorsPerElement(const char* fileName,
  const char* description,
  int timeStep,
  vtkMultiBlockDataSet *compositeOutput)
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::ReadTensorsPerElement(const char* fileName,
  const char* description,
  int timeStep,
  vtkMultiBlockDataSet *compositeOutput)
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::CreateUnstructuredGridOutput(int partId,
  char line[256],
  const char* name,
  vtkMultiBlockDataSet *compositeOutput)
{
  ...
  while(lineRead && strncmp(line, "part", 4) != 0)
    ...
    if (strncmp(line, "coordinates", 11) == 0)
      ...
      for (i = 0; i < numElements; i++)
        ...
        this->GetCellIds(idx, vtkEnSightReader2::NSIDED)->InsertNextId(cellId);
        lineRead = this->ReadNextDataLine(line);
        delete [] nodeIds;
        delete [] intIds;
        }
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::CreateStructuredGridOutput(int partId,
  char line[256],
  const char* name,
  vtkMultiBlockDataSet *compositeOutput)
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::CreateRectilinearGridOutput(int partId,
  char line[256],
  const char* name,
  vtkMultiBlockDataSet *compositeOutput)
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::CreateImageDataOutput(int partId,
  char line[256],
  const char* name,
  vtkMultiBlockDataSet *compositeOutput)
{
...
//----------------------------------------------------------------------------
int vtkEnSightGoldReader2::CheckForUndefOrPartial(const char *line)
{
  char undefvar[16];
  ...
  if( r == 1)
    ...
    if( strcmp(undefvar, "undef") == 0 )
      ...
      switch( this->GetSectionType(line) )
        {
      case vtkEnSightReader2::COORDINATES:
        this->UndefPartial->UndefCoordinates = val;
        break;
      case vtkEnSightReader2::BLOCK:
        this->UndefPartial->UndefBlock = val;
        break;
      case vtkEnSightReader2::ELEMENT:
...
//----------------------------------------------------------------------------
void vtkEnSightGoldReader2::PrintSelf(ostream& os, vtkIndent indent)
{
