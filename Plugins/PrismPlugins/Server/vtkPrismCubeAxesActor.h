...
=========================================================================*/
// .NAME vtkPrismCubeAxesActor - create a  plot of a bounding box edges - 
// used for navigation
// .SECTION Description
// vtkPrismCubeAxesActor is a composite actor that draws axes of the 
...
// to render the vtkPrismCubeAxesActor. You can optionally turn on/off labels,
...
// 
// .SECTION See Also
// vtkActor vtkAxisActor vtkPrismCubeAxesActor2D

#ifndef __vtkPrismCubeAxesActor_h
#define __vtkPrismCubeAxesActor_h
...
public:
  ...
  // per axis set to 3.
  static vtkPrismCubeAxesActor *New();
  ...
  void ShallowCopy(vtkPrismCubeAxesActor *actor);
...
private:
  vtkPrismCubeAxesActor(const vtkPrismCubeAxesActor&); // Not implemented
  void operator=(const vtkPrismCubeAxesActor&); // Not implemented
